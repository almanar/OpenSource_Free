...
* Parameters:
*               port:
*                       virtual modem serial port number
* Return:        
...
*               This function is deprecated, and a new function is
*               available: Ql_SendToUart_2
* Parameters:
*               port:
*                       UART port
*               data:
...
/*****************************************************************
* Function:     Ql_SendToUart_2 
* 
* Description:
*               Send data to the specified UART port.
*               This function is identical with 'Ql_SendToUart' functionally.
*               But, when the number of bytes actually sent is less than
...
*               please see 'Error Code Definition'.
*****************************************************************/
//extern s32  (*Ql_SendToUart_2)(QlPort port, u8* data, u16 data_len);
...
*
*               totalbufffer_size:
*                       [out] Pointer to the total number of bytes of of 
*                       the send buffer. 
...
/*****************************************************************
* Function:     Ql_UartDirectnessReadData 
* 
* Description:
