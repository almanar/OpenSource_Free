...
*           Through Uart port, input the special command, there will be given the response about eint operation.
*
*   Usage:
*
*           Precondition:
...
*           Through Uart port:
*
*               If input "1", that will subscribe pin to mode1.
*               If input "3", that will subscribe pin to mode3, EINT function.
*               If input "u", that will unsubscribe pin.
